...
export default function ReportSuccess() {
  ...
  return (
    <View className="relative flex-1 items-center justify-center px-6 pt-3 pb-25 bg-white dark:bg-dark-bg">
      ...
      <ThemedText className="text-3xl font-montserrat-bold text-gray-900 dark:text-white text-center">
        Reporte Enviado
      </ThemedText>
      <ThemedText className="text-base text-gray-600 dark:text-gray-400 font-montserrat-regular text-center">
        Las autoridades han sido notificadas.
      </ThemedText>
      <ThemedText className="text-base text-green-600 dark:text-green-500 font-montserrat-semibold text-center">
      ...
      <View className="w-full mt-4">
        <View className="flex-row items-center mb-4">
          ...
          <ThemedText className="text-lg font-montserrat-bold text-gray-900 dark:text-white">
            ¿Qué hacer ahora?
          </ThemedText>
        </View>
          ...
          {safetyTips.map((tip, index) => (
            ...
            >
              ...
              <View className="flex-1">
                <ThemedText className="text-base font-montserrat-semibold text-gray-900 dark:text-white">
                  {tip.title}
                </ThemedText>
                <ThemedText className="text-sm text-gray-600 dark:text-gray-400 font-montserrat-regular mt-1">
                  {tip.description}
                </ThemedText>
              </View>
            </View>
