  ...
  return (
    <View>
      <View className="flex-row items-center gap-2 my-2">
        <ThemedText className="text-sm font-bold uppercase text-gray-500">Perfil y privacidad</ThemedText>
      </View>

      <Button variant="ghost" className="py-2 w-full justify-start">
        <View className="w-full flex-row items-center justify-between">
          <View className="flex-row items-center gap-2">
            <View className="h-12 w-12 bg-gray-200/60 flex-row items-center justify-center gap-1 rounded-full">
