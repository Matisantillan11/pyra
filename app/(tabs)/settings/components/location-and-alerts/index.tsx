  ...
  return (
    <View className="shadow-lg rounded-lg">
      <View className="flex-row items-center gap-2 my-2">
        <ThemedText className="text-sm font-bold uppercase text-gray-500">Ubicación y alertas</ThemedText>
      </View>

      <Button variant="ghost" className="py-2 w-full justify-start shadow-none">
        <View className="w-full flex-row items-center justify-between">
          <View className="flex-row items-center gap-2">
            <View className="h-12 w-12 bg-cyan-900/40 flex-row items-center justify-center gap-1 rounded-full">
          ...
          <View className="flex-row items-center gap-2">
            <ThemedText className="text-xs font-medium text-gray-500">Bariloche</ThemedText>
      ...
      <Button variant="ghost" className="py-2 w-full justify-start shadow-none">
        <View className="w-full flex-row items-center justify-between">
          <View className="flex-row items-center gap-2">
            <View className="h-12 w-12 bg-orange-200/60 flex-row items-center justify-center gap-1 rounded-full">
      ...
      <Button variant="ghost" className="py-2 w-full justify-start shadow-none">
        <View className="w-full flex-row items-center justify-between">
          <View className="flex-row items-center gap-2">
            <View className="h-12 w-12 bg-red-200/60 flex-row items-center justify-center gap-1 rounded-full">
