...
export const buttonVariants = cva("rounded-lg items-center justify-center font-medium", {
  variants: {
    variant: {
      ...
      ghost: "bg-white/80 border-none hover:bg-white/90 active:bg-white/90 disabled:bg-white/80 disabled:hover:cursor-not-allowed disabled:active:cursor-not-allowed shadow-lg",
    },
    size: {
